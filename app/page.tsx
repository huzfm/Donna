        ...
        {uploadedFiles.length > 0 && (
          <div className="space-y-1">
            ...
            {uploadedFiles.map((name, i) => (
              <div
                key={i}
                className="text-xs text-green-400 bg-gray-900 rounded px-2 py-1 truncate"
              >
                ✅ {name}
              </div>
            ))}
          ...
          {chat.length === 0 && (
            <div className="text-center text-gray-600 mt-20">
              ...
              <div className="text-xs mt-2 text-gray-700">
                e.g. "What is the total in the Excel sheet?" or "Who is mentioned in the PDF?"
              </div>
            </div>
          )}
...
>>>>>>> 2d8f9c1311962f3ec35b13596f3c1cc30b7f96b9
    </div>
  );
}
