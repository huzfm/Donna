        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
          {techStack.map((tech, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="group rounded-2xl border border-slate-200/90 bg-white p-6 shadow-sm transition-all duration-300 hover:border-emerald-200 hover:shadow-lg hover:shadow-emerald-500/5"
            >
              <div
              ...
              <p className="mt-1 text-sm text-slate-500">{tech.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
